...
function App() {
  ...
  setNbreCoup(nbreCoup + 1);
  console.log(nbreCoup);
  return true
  }
  ...
  return (
    <TableauContext.Provider value={contextValue}>
      <div className="App">        
              <Box jouer={jouer} myRef={myRef} issu={issu} nbreCoup={nbreCoup}/>
              {
                issu  ?(              
              ...
              <button className='reload' onClick={reload}>Restart</button>
      </div>
